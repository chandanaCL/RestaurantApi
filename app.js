...
const mongoUrl = "mongodb+srv://Chandana:cvml462ccl4*@cluster0.k8gwc.mongodb.net/hotels?retryWrites=true&w=majority";
...
app.get('/',(req,res) => {
    res.send("<div><a href='http://localhost:8900/location'>Location</a><br/><a href='http://localhost:8900/mealtype'>MealType</a><br/><a href='http://localhost:8900/cuisine'>Cuisine</a><br/><a href='http://localhost:8900/restaurant'>Restaurant</a><br/><a href='http://localhost:8900/orders'>Orders</a></div>")
})
